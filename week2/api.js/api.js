let fish = [
    {
        ...
        "Image Gallery": [
            {
                "src": "https://www.fishwatch.gov/sites/default/files/snapperred_1.jpg",
                "alt": "Red snapper in Gray&#039;s Reef National Marine Sanctuary.",
                "title": "Red snapper in Gray&#039;s Reef National Marine Sanctuary."
            },
            {
                "src": "https://www.fishwatch.gov/sites/default/files/snapperred_2.jpg",
            ...
            {
                "src": "https://www.fishwatch.gov/sites/default/files/snapperred_3.jpg",
                "alt": "A fisherman holds up his red snapper catch.",
                "title": "A fisherman holds up his red snapper catch."
            },
            {
                "src": "https://www.fishwatch.gov/sites/default/files/snapperred_4.jpg",
            ...
            {
                "src": "https://www.fishwatch.gov/sites/default/files/snapperred_7.jpg",
                "alt": "Red Snapper",
                "title": ""
            }
        ],
...
// p.textContent = JSON.stringify(fish)
// document.body.append(p)
// console.log(fish[0])
// console.log(Object.keys(fish[0]))
// console.log(Object.keys(fish[0]).length)
// console.log(Object.values(fish[0]))
// console.log(Object.values(fish[0]).length)

for (var i = 0; i < Object.keys(fish[0]).length; i++)
{var p = document.createElement("p")
if (Object.keys(fish[0])[i] === "Image Gallery")
{
    var imageGallery = Object.values(fish[0])[i]
    for (var i = 0; i < imageGallery.length; i++){
        console.log(imageGallery[i])
        // var galleryKeys = Object.keys(imageGallery[i])
        // var galleryValues = Object.values(imageGallery[i])
        // p.innerHTML += galleryKeys + "-"+"<br>" + galleryValues + "<br>"
        var img = document.createElement("img")
        p.append(img)
        img.src = imageGallery[i].src
        img.alt = imageGallery[i].alt
        img.title = imageGallery[i].title
    }
}
else if (Object.keys(fish[0])[i] === "Species Illustration Photo")
{
    var speciesPhoto = Object.values(fish[0])[i]
    console.log(speciesPhoto, "speciesPhoto")
    console.log(speciesPhoto)
    var img = document.createElement("img")
    p.append(img)
    img.src = speciesPhoto.src
    img.alt = speciesPhoto.alt
    img.title = speciesPhoto.title
}
else
{p.innerHTML = Object.keys(fish[0])[i] + "-" + Object.values(fish[0])[i]}
document.body.append(p)} 
